...
/* v3: assembly_data.js regenerated with the true blank silhouettes and the recut
   sheet. An unbumped cache serves the old data forever on a bad-wifi phone. */
const CACHE = 'assembly-guide-v3';
